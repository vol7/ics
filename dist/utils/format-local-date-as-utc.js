...
exports["default"] = formatLocalDateAsUTC;
...
function formatLocalDateAsUTC() {
  ...
  if (args.length > 0) {
    ...
    var formattedDate = (0, _moment["default"])([year, month - 1, date, hours, minutes, seconds]).utc().format('YYYYMMDDTHHmm00') + 'Z';
